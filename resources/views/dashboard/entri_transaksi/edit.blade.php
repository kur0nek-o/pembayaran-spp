...
<a href="/history" class="btn btn-warning mb-3">Kembali</a>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header mb-3">
                    <h5 class="card-title p-0 mb-0">History Pembayaran</h5>
                </div>
                <div class="card-body">

                    <form action="/edit-history/{{ $pembayaran->id_pembayaran }}" id="pembayaran-form" method="POST" class="row g-3" autocomplete="off">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="form-floating">
                                ...
                                >
                                    ...
                                    @foreach($bulan as $item)
                                        <option value="{{ $item }}" {{ old('pembayaran-spp', $curr_bulan) == $item ? 'selected' : '' }} >{{ $item }}</option>
                                    @endforeach
                                </select>
                                <label for="pembayaran-spp">Pilih bulan pembayaran</label>
